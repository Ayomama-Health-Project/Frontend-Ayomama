      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <View className="px-6 pt-4 pb-2">
          <View className="flex-row items-center justify-between mb-1">
            ...
            <TouchableOpacity
              onPress={() => router.push("/(health-worker-with-clinic-tabs)/profile")}
              activeOpacity={0.7}
              style={{
                width: 44,
                height: 44,
        ...
        <View className="px-6 mb-4">
          ...
          <View className="flex-row gap-3">
            <TouchableOpacity
              onPress={() => router.push("/(health-worker-with-clinic-tabs)/addPatient")}
              activeOpacity={0.8}
            ...
            <TouchableOpacity
              onPress={() => router.push("/(health-worker-with-clinic-tabs)/patients")}
              activeOpacity={0.8}
              style={{
                flex: 1,
                backgroundColor: "#FFFFFF",
        ...
        <View className="px-6 mb-8">
          <View className="flex-row items-center justify-between mb-3">
            ...
            <TouchableOpacity
              onPress={() => router.push("/(health-worker-with-clinic-tabs)/visits")}
              activeOpacity={0.7}
            >
