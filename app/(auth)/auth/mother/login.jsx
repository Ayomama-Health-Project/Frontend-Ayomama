...
const LogIn = () => {
  ...
  // Translate all text
  const titleText = useTranslation("Welcome Back");
  const subtitleText = useTranslation("We are delighted to have you back");
    ...
    try {
      ...
      if (account?.role !== "mother") {
        ...
        Toast.show({
          ...
          text2: getRoleMismatchMessage("mother", account),
          position: "top",
        });
        setTimeout(() => {
          router.replace(
